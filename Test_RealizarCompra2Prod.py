...
time.sleep(1)
driver.find_element(By.ID, "first-name").send_keys('XCXCXCXC')
time.sleep(1)
driver.find_element(By.ID, "last-name").send_keys('QWQIWQ')
time.sleep(1)
driver.find_element(By.ID, "postal-code").send_keys('348481518')
time.sleep(1)
